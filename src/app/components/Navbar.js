              ...
              {!user ? (
                <>
                  <Link
                    ...
                    className="block w-full px-3 py-3 rounded-t hover:bg-[#2B3F50] hover:text-white transition-colors"
                  >
                    Register
                  </Link>
                  <Link
                    href="/login"
                    className="block w-full px-3 py-3 rounded-b hover:bg-[#2B3F50] hover:text-white transition-colors"
                  >
                    Login
                  </Link>
                </>
